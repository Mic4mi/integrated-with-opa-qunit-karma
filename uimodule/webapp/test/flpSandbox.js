		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Simple project for testing",
									"targetURL": "#accmyproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"accmyproject-display": {
								"semanticObject": "accmyproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=acc.myproject",
									"url": sap.ui.require.toUrl("acc/myproject")
								}
							}
						}
					}
